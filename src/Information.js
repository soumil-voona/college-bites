...
const Information = () => {
  return (
    ...
    <div className="info-opening">
        ...
        <a href = '/login'><div className = 'btn homepage'><span className = 'btnTxt'>I am a customer</span></div> </a>
        <a href='/driverPortal' ><div className = 'btn homepage'><span className = 'btnTxt'>I am a driver</span></div></a>
    </div>
